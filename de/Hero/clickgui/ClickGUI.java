...
public class ClickGUI extends GuiScreen {
	...
	public ClickGUI() {
		setmgr = zer0.instance.settingsManager;
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		/* https://www.youtube.com/channel/UCJum3PIbnYvIfIEu05GL_yQ	*/ FontUtil.drawStringWithShadow(" ", -Minecraft.getMinecraft().fontRendererObj.getStringWidth(" "), -Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT, 0xff11F86B);
		/*															*/ GL11.glPopMatrix();
