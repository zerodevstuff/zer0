...
import me.zerodevstuff.zer0.module.render.Xray;
...
public class Block
{
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
    {
    	...
    	if(this == Block.getBlockById(14)) //gold
    		return true;
    	if(this == Block.getBlockById(56)) //diamond
    		return true;
    	if(this == Block.getBlockById(21)) //lapis
    		return true;
    	if(this == Block.getBlockById(16)) //coal
    		return true;
    	if(this == Block.getBlockById(15)) //iron
    		return true;
    	if(this == Block.getBlockById(120)) //end portal frame
    		return true;
    	if(this == Block.getBlockById(11)) //lava (might crash)
    		return true;
    	if(this == Block.getBlockById(9)) //water
    		return true;
    	if(this == Block.getBlockById(49)) //obsidian
    		return true;
    	if(this == Block.getBlockById(8)) //flow water
    		return true;
    	if(this == Block.getBlockById(10)) //flow lava
    		return true;
    	if(this == Block.getBlockById(153)) //quartz
    		return true;
    	if(this == Block.getBlockById(129)) //emerald
    		return true;
